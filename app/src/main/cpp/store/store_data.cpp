...
uint8_t store_0[7] = {65, 66, 101, 102, 122, 124, 117,};
uint8_t store_1[3] = {205, 203, 210,};
uint8_t store_2[6] = {41, 42, 43, 29, 9, 17,};
uint8_t store_3[4] = {169, 163, 165, 202,};
uint8_t store_4[1] = {8,};
uint8_t store_5[2] = {2, 11,};
uint8_t store_6[1] = {39,};
uint8_t store_7[2] = {86, 87,};
uint8_t store_8[2] = {86, 87,};
uint8_t store_9[3] = {40, 41, 42,};
uint8_t store_10[2] = {20, 22,};
uint8_t store_11[13] = {169, 169, 163, 169, 169, 165, 1, 2, 1, 4, 6, 1, 165,};
uint8_t store_12[13] = {13, 2, 1, 13, 9, 8, 1, 129, 129, 8, 129, 129, 202,};
uint8_t store_13[13] = {14, 14, 14, 14, 14, 14, 10, 20, 50, 10, 20, 50, 169,};
uint8_t store_14[2] = {169, 170,};
uint8_t store_15[5] = {1, 2, 3, 4, 5,};

uint8_t *stores_data[16] = {
...
uint8_t stores_size[16] = {
        7, 3, 6, 4, 1, 2, 1, 2, 2, 3,
        2, 13, 13, 13, 2, 5,};

uint8_t vendor_data[18][6 * 2 + 1] = {
